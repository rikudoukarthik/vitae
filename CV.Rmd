...
detailed_emp <- tribble(
  ...
  "Senior Research Assistant", "Apr 2023", c(
    ...
    "SoIB 2023: Cleaned, structured and organised GitHub repository",
    "SoIB 2023: Unified various analyses into pipeline framework, functionised/parametrised scripts and added annotations, to improve accessibility to team as well as others",
    "SoIB 2023: Contributed to analysis, visualisation and writing for two chapters (large-scale trends, systematic monitoring), and also produced website-specific outputs",
  ...
  "Research Assistant", "Aug 2021", c(
    "Analysed the effect of the COVID-19 pandemic on birdwatching and eBird data in India, and its implications for research using this data; wrote up and submitted manuscript to a peer-reviewed journal",
        ...
        "Created a periodic (recurring) analysis framework to identify and track regions in India that are most underrepresented in eBird data, in order to identify regions of priority where concerted action (strategised from these metrics) is required",
        "Created eBirding point maps for the country as well as for each state in India, made easily accessible and updated monthly",
        "Automated several periodically occurring data analysis tasks of Bird Count India, such as own tracking metrics, results of monthly & yearly challenges as well as major birding events, Patch Monitoring Project, etc.)",
        "In addition to post-hoc birding event summaries, created automatable scripts to generate live summaries, using eBird API and R",
