...
\> National Seminar on Development and Ecological Sustainability: Issues in Emerging India 2018, \\
\> Bengaluru, IN. \\
...
tribble(
  ...
  "Volunteer", "Bird Monitoring Symposium", "Online", "Apr 2022", "Managed session talks, Q&As and comments on Discord, as well as assisted participants with queries.",
) %>% 
  detailed_entries(WHAT, dates, EVENT, loc, details)
```
